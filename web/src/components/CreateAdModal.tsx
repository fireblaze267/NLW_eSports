...
export function CreateAdModal() {
  ...
  return (
    <Diaolog.Portal>
      <Diaolog.Overlay className="bg-black/60 inset-0 fixed" />
      <Diaolog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
        <Diaolog.Title className="text-3xl font-black ">
          Publique um Anúncio
        </Diaolog.Title>
        ...
        <form onSubmit={handleCreateAdd} className="mt-8 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="discord">Qual o seu dicord?</label>
